		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Variant Managmnet App",
									"targetURL": "#variantDemovariantmanagmentapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"variantDemovariantmanagmentapp-display": {
								"semanticObject": "variantDemovariantmanagmentapp",
								"action": "display",
								"description": "A Fiori application demo.",
								"title": "Variant Managmnet App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=variantDemo.variantmanagmentapp",
									"url": sap.ui.require.toUrl("variantDemo/variantmanagmentapp")
								}
							}
						}
					}
